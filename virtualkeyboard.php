...
function virtualkeyboard_head(){
	global $keyboard_image;
...
(function VKI_buildKeyboardInputs() {
  ...
  this.VKI_imageURI = "<?php echo $keyboard_image;?>";  // If empty string, use imageless mode
...
function virtualkeybaord_footer(){
	?>
...
if(function_exists('add_action')){
	add_action('wp_head','virtualkeyboard_head');
	add_action('admin_head','virtualkeyboard_head');
	add_action('wp_footer','virtualkeybaord_footer');
	add_action('admin_footer','virtualkeyboard_footer');
}
?>